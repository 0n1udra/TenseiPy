...
def ch1_cave(rimuru):
    ...
    class in_water:
        ...
        def __init__(self):
            ...
            idots()
            siprint("\nI thought of something... I could suck up some of water then I can and expel it at a high pressure...")
            game_action(self)
