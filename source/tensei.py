...
class Scene_Intro(Scene_Template):
    ...
    def SceneStart(self):
        ...
        sprint("***Although Minami Satoru didn't want to admint it.***")
        sprint("***He has reincarrnated into a rimuru!***")

        sprint(ascii.slime)

        sprint("puyo, puyoyoyo.... stretch....bounce")
        sprint("It's been a long time since I've accepted myself as a rimuru.")
        ...
        sprint("***Getting carried away and not having all of his normal senses. The little rimuru fell into what seemed to be water***")
        ...
        sprint("<<Answer. A rimuru's body does not need oxygen.>>")
        sprint("I am indeed not feeling any pain, at this time my brain cells (or rimuru body) thought up a strategy.")
        ...
        sprint("Right now I am in a state that's unable to see anythinn....um you are?")
        sprint("*This is telapathy*")
        sprint("*Mmmmm, My name is....*")
        sprint("*It's Hard to converse if you can't see...*")
        sprint("*Aliright, I'll help you see*")
        sprint("eh?")
